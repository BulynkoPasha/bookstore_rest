...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Book gulag = save(book("The Gulag Archipelago", "Архипелаг ГУЛАГ",
                "Aleksandr Solzhenitsyn", "Александр Солженицын", "9781843430858", "24.99",
                "A monumental investigation into the Soviet prison camp system.",
                "Монументальное исследование советской лагерной системы.",
                Set.of(history)));
